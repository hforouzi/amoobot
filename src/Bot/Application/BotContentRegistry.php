...
final class BotContentRegistry
{
    ...
    private function persianMessages(): array
    {
        return [
            ...
            'discount.applied' => ['title' => 'Discount applied', 'body' => 'کد تخفیف اعمال شد.', 'category' => 'discounts'],
            'discount.invalid' => ['title' => 'Discount invalid', 'body' => 'کد تخفیف معتبر نیست.', 'category' => 'discounts'],
            'discount.skipped' => ['title' => 'Discount skipped', 'body' => 'بدون کد تخفیف ادامه می‌دهیم.', 'category' => 'discounts'],
